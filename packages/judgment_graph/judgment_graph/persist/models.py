...
judgment_outbox = Table(
    ...
    Column("acked_at", DateTime(timezone=True)),
    ...
    UniqueConstraint("event_id", name="uq_judgment_outbox_event_id"),
    UniqueConstraint(
        "event_type",
        "content_id",
        "source_revision",
...
Index(
    ...
    judgment_outbox.c.acked_at,
    judgment_outbox.c.dead_lettered_at,
    judgment_outbox.c.sent_at,
    judgment_outbox.c.created_at,
)
